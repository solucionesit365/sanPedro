                                                ...
                                                if (typeof arrayTickets[0].lista[j].promocion.infoPromo.tipoPromo == 'string') {
                                                    if (arrayTickets[0].lista[j].promocion.infoPromo.tipoPromo == 'COMBO') {
                                                        if (arrayTickets[0].lista[j].promocion.infoPromo.idPrincipal != 0 && arrayTickets[0].lista[j].promocion.infoPromo.idSecundario != 0 && typeof arrayTickets[0].lista[j].promocion.infoPromo.idPrincipal == 'number' && typeof arrayTickets[0].lista[j].promocion.infoPromo.idSecundario == 'number') {
                                                            ...
                                                            sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${parametros.codigoTienda}, CONVERT(datetime, '${infoTime.year}-${infoTime.month}-${infoTime.day} ${infoTime.hours}:${infoTime.minutes}:${infoTime.seconds}', 120), ${arrayTickets[0].idTrabajador}, ${arrayTickets[0]._id}, '', ${arrayTickets[0].lista[j].promocion.infoPromo.idPrincipal}, ${arrayTickets[0].lista[j].promocion.infoPromo.cantidadPrincipal*arrayTickets[0].lista[j].promocion.infoPromo.unidadesOferta}, ${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL") ? 0: importePrincipal}, '${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL")? "Desc_100" : "V"}', '${(arrayTickets[0].lista[j].suplementosId) ? arrayTickets[0].lista[j].suplementosId.toString() : 0}', '${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL")? idFinalTrabajador : campoOtros}');`; 
                                                            sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${parametros.codigoTienda}, CONVERT(datetime, '${infoTime.year}-${infoTime.month}-${infoTime.day} ${infoTime.hours}:${infoTime.minutes}:${infoTime.seconds}', 120), ${arrayTickets[0].idTrabajador}, ${arrayTickets[0]._id}, '', ${arrayTickets[0].lista[j].promocion.infoPromo.idSecundario}, ${arrayTickets[0].lista[j].promocion.infoPromo.cantidadSecundario*arrayTickets[0].lista[j].promocion.infoPromo.unidadesOferta}, ${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL") ? 0: importeSecundario}, '${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL")? "Desc_100" : "V"}', '${(arrayTickets[0].lista[j].suplementosId) ? arrayTickets[0].lista[j].suplementosId.toString() : 0}', '${(arrayTickets[0].tipoPago === "CONSUMO_PERSONAL")? idFinalTrabajador : campoOtros}');`; 
                                                            numArticulos += 1;
                                                        } else {
